...
import com.lil_antony.item.custom.AlcoholItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> RUM = ITEMS.register("rom",
            () -> new AlcoholItem(new Item.Properties().food(
                   new FoodProperties.Builder().effect(
                           new MobEffectInstance(MobEffects.DAMAGE_BOOST, 900), 1.0f).effect(
                            new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 900), 1.0f).build()), "Alco"));

    public static final RegistryObject<Item> KONYAK = ITEMS.register("konyak",
            () -> new AlcoholItem(new Item.Properties().food(
                    new FoodProperties.Builder().effect(
                            new MobEffectInstance(MobEffects.DAMAGE_BOOST, 900), 1.0f).effect(
                            new MobEffectInstance(MobEffects.CONFUSION, 900), 1.0f).build()), "Alco"));
    ...
    public static final RegistryObject<Item> VINO = ITEMS.register("vino",
            () -> new AlcoholItem(new Item.Properties().food(
                    new FoodProperties.Builder().effect(
                            new MobEffectInstance(MobEffects.HEAL, 100), 1.0f).build()), "Alco"));

    public static final RegistryObject<Item> APPLEJUSE = ITEMS.register("applejuice",
            () -> new AlcoholItem(new Item.Properties().food(
                    new FoodProperties.Builder().build()), "Juise"));
    ...
    public static final RegistryObject<Item> ROWBERRIESEJUSE = ITEMS.register("rowberriesjuice",
            () -> new AlcoholItem(new Item.Properties().food(
                    new FoodProperties.Builder().effect(
                            new MobEffectInstance(MobEffects.NIGHT_VISION, 600), 1.0f).build()), "Juise"));
    ...
    public static final RegistryObject<Item> SPIRITMILK = ITEMS.register("spiritmilk",
            () -> new AlcoholItem(new Item.Properties().food(
                    new FoodProperties.Builder().effect(
                            ...
                            new MobEffectInstance(MobEffects.WITHER, 100), 1.0f).build()), "Juise"));
    public static final RegistryObject<Item> ELFPOTION = ITEMS.register("elfpotion",
            () -> new AlcoholItem(new Item.Properties().food(
                    new FoodProperties.Builder().effect(
                            ...
                            new MobEffectInstance(MobEffects.REGENERATION, 2400), 1.0f).build()), "Alco"));

    public static final RegistryObject<Item> VINOGRAD = ITEMS.register("vinograd",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().alwaysEat().build())));
    ...
    public static final RegistryObject<Item> SMOKINGPIPE = ITEMS.register("pipe",
            () -> new SmokeItem(new Item.Properties().stacksTo(1).durability(20), 1.0F));
