...
public class CoffeTrunkPlacer extends TrunkPlacer {

    public static final Codec<CoffeTrunkPlacer> CODEC = RecordCodecBuilder.create(pineTrunkPlacerInstance ->
            trunkPlacerParts(pineTrunkPlacerInstance).apply(pineTrunkPlacerInstance, CoffeTrunkPlacer::new));

    public CoffeTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.COFFE_TRUNK_PLACER.get();
    }
